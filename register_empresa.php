        ...
        <form id="form_registro" onsubmit="event.preventDefault(); return GuardarRegistro();">
            <div class="d-block my-3">
                ...
                <div class="form-group input-group">
                    ...
                    <input name="nombre1" required class="form-control" placeholder="Razon social" type="text">
                    <input name="nombre2" style="display:none" class="form-control" placeholder="Segundo nombre" type="text">
                </div> <!-- form-group// -->
                <div class="form-group input-group" style="display:none">
                    <div class="input-group-prepend">
                        <span class="input-group-text"> <i class="fa fa-user"></i> </span>
                    </div>
                    <input name="apellido1" class="form-control" placeholder="Primer apellido" type="text">
                ...
                <label style="display:none" for="">Fecha de nacimiento</label>
                <div style="display:none" class="form-group input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"> <i class="fa fa-birthday-cake"></i> </span>
                    </div>
                    <select name="day" id="day" class="custom-select" style="max-width: 80px;">
                    ...
                    <select name="month" id="month" class="custom-select" style="max-width: 80px;">
                ...
                <div style="display:none"><!-- class="d-block my-3"// -->
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="hombre" checked value="Hombre" name="sexo" type="radio" class="custom-control-input">
                        <label class="custom-control-label" for="hombre">Hombre</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input id="mujer" value="Mujer" name="sexo" type="radio" class="custom-control-input">
                ...
                <div style="display:none" class="form-group input-group">
                    ...
                    <select name="id_etnia" id="etnia" class="custom-select tipo_etnia">
                        <option value=""> Etnia</option>
                    </select>
                    <select name="id_poblacion" id="poblacion"  class="custom-select tipo_poblacion">
                ...
                <div style="display:none" class="form-group input-group">
                    ...
                    <select name="id_entidad" id="eps" class="custom-select entidades">
                        <option value=""> EPS</option>
                    </select>
                    <select name="id_ciclo_vida" id="ciclo_vida"  class="custom-select tipo_ciclo_vida">
...
$(function() {
    ...
    function GuardarRegistro() {
        $.ajax({
            type : 'POST',
            data: $("#form_registro").serialize()+"&tipo_persona=2&tipo_entidad=Privada",
